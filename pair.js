        ...
        try {
            ...
            Pair_Code_By_Arslan_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Arslan_Tech.sendMessage(Pair_Code_By_Arslan_Tech.user.id, { text: 'SHAHBAZ-MD~' + b64data });
...
║ 『••• _V𝗶𝘀𝗶𝘁 𝗙𝗼𝗿_H𝗲𝗹𝗽 •••』
║❍ 𝐎𝐰𝐧𝐞𝐫: +923191285720
║❍ 𝐑𝐞𝐩𝐨: https://github.com/shahzebyc3/SHAHBAZ-MD
║❍ 𝐖𝐚𝐆𝗿𝐨𝐮𝐩: https://chat.whatsapp.com/LX1RjD8CTpa5vnf5DPWaS6?mode=gi_t
║❍ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029Vb75RsG9Gv7Lr28vn92O
║
║ ☬ ☬ ☬ ☬
╚═════════════════════╝
𒂀 Enjoy SHAHBAZ-MD
